...
var CSVLink = function (_React$Component) {
  ...
  function CSVLink(props) {
    ...
    _this.clearDownloadComponent = _this.clearDownloadComponent.bind(_this);
    return _this;
  }
  ...
  _createClass(CSVLink, [{
    ...
    value: function downloadFile(data) {
      ...
      this.setState({ downloadComponent: _react2.default.createElement(_Download2.default, { data: csvData }) }, this.clearDownloadComponent);
    }
  }, {
    key: 'clearDownloadComponent',
    value: function clearDownloadComponent() {
      ...
      return _react2.default.createElement(
        ...
        _extends({ download: filename }, rest, {
          onClick: function onClick() {
            return _this2.downloadFile(data, uFEFF, headers, separator);
          } }),
        children,
